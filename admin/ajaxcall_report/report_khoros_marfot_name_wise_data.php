<?php
    ...
    $mot_bill = 0;
    $mot_joma = 0;
    if($search_date == 'alldates' && $khoros_marfot_name == 'none'){  //condition one
        $i = 1;
        $qry = "SELECT * FROM debit_group_data WHERE project_name_id = '$project_name_id'";
        $reads = $db->select($qry);
        if ($reads && mysqli_num_rows($reads) > 0) {
            echo '<table class="tableshow" id="tableshow" style="border: 1px solid #ddd; font-size: 14px; border-collapse: collapse;">';
                echo $table_header;
    ...
    } else if($search_date == 'alldates' && $khoros_marfot_name != 'none'){  //condition two
        $i = 1;
    ...
    } else if ($search_date != 'alldates' && $khoros_marfot_name == 'none'){  //condition three
        $i = 1;
        $qry = "SELECT * FROM debit_group_data WHERE entry_date = '$search_date' AND project_name_id = '$project_name_id'";
        $reads = $db->select($qry);
        if ($reads && mysqli_num_rows($reads) > 0) {
            echo '<table class="tableshow" id="tableshow" style="border: 1px solid #ddd; font-size: 14px; border-collapse: collapse;">';
                echo $table_header;
    ...
    } else if ($search_date != 'alldates' && $khoros_marfot_name != 'none'){  //condition four
        $i = 1;

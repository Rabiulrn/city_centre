	...
	<div class="bar_con">
		...
		<div class="left_side_bar menu">
			<div id="left_all_menu_con">
				...
				<a href="../vaucher/pathor_report_dealer.php" class="active">ডিলার</a>
		...
		<div class="main_bar">
			...
			?>
			<div class="project_heading text-center">
				<h2 class="text-center" style="font-size: 23px; line-height: 22px;">ডিলার</h2>
			</div>

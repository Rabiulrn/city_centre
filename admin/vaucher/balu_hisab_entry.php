<?php 
  ...
  if(isset($_POST['submit'])){
      ...
      if($submitBtn_value == 'Save'){
          $category_id     = $newId;
          $sql="INSERT INTO balu_category (category_id, category_name) VALUES ('$category_id','$category_name')";
...
<head>
    ...
    <style type="text/css">
      ...
      .balu_categorysTableCon{
          width: 100%;
          margin-bottom: 0px;
		  background-color: gray;
      }
      .balu_categorysTableCon tr th {
        border: 1px solid #ddd;
        text-align: center;
      }
      .balu_categorysTableCon tr td {
        border: 1px solid #ddd;
        padding: 2px;
      }
      .borderLess {

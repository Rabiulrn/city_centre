...
$arrA = explode('/', $_POST['minDate']);
$postMinDate = $arrA[2].'/'.$arrA[1].'/'.$arrA[0];

$arrB = explode('/', $_POST['maxDate']);
$postMaxDate = $arrB[2].'/'.$arrB[1].'/'.$arrB[0];

// echo $postMinDate." ";
// echo $postMaxDate." ";
// echo "\n";
$minDate = date('Y-m-d', strtotime($postMinDate));
$maxDate = date('Y-m-d', strtotime($postMaxDate));
// echo $minDate . " ";
// echo $maxDate;
...
?>
  ...
  <?php 
      ...
      $sqls="select * from nij_paonadar WHERE nij_paona_date BETWEEN '$minDate' AND '$maxDate'";
  ...
  ?>
    ...
    <?php  
      ...
      $paona_query = "SELECT * FROM jara_pabe WHERE pabe_date BETWEEN '$minDate' AND '$maxDate'";
  ...
  <?php 
    ...
    $query = "SELECT * FROM debit_group WHERE group_date BETWEEN '$minDate' AND '$maxDate'";

	...
	<div class="bar_con">
		...
		<div class="left_side_bar menu">
			<div id="left_all_menu_con">
				...
				<a href="../vaucher/rod_report_dealer.php" class="active">ডিলার</a>
					...
					<div class="optionsCon">
						<span style="position: relative; top: -13px;">
		    				...
		    				<select class="selctpik2" id="searchDealer">
		    					...
		    					<?php
		    						$sql = "SELECT DISTINCT dealer_id, dealer_name FROM dealers WHERE project_name_id = '$project_name_id' ORDER BY dealer_name ASC";
		    						$rslt = $db->select($sql);
	...
	<script type="text/javascript">
		...
		$(document).on('change', '#searchDealer', function(){
			...
			if(searchDealer == 'alldealers'){
				window.location = '../vaucher/rod_report_dealer.php';
			} else {

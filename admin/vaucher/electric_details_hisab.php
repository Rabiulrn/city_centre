...
$db = new Database();
$_SESSION['pageName'] = 'electric_details_hisab';
        ...
        <div class="col-md-11">
          ...
          <div class="inlineDivarea">
            <button type="button" class="btn btn-info" onclick="getAllDetails()" id="showAllDates">Show all datas</button>
              ...
              <div class="NameDiv inlineDivarea"> </div>
              <!-- <div class="inlineDivarea" > 
    ...
    function getAllDetails() {
      ...
      $.ajax({
        ...
        success: function(response, status) {
          ...
          console.log("Alldata_area =============", response)
        },

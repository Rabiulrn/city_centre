      ...
      <div class="container">
          ...
          <form action="" method="POST" onsubmit="return validation()">
              ...
              <table class="table table-bordered table-condensed" id="dynamic_field">                
                  <thead>
                    <tr>
                      <th class="text-center bg-primary" colspan="4" ‍>পাওনাদার টাকা (-) এন্ট্রি</th>
                    </tr>
                    <tr>
                  ...
                  <tbody>
                      <tr>
                        ...
                        <td><input type="text" name="name" class="form-control" size="100" value="<?php echo $name_read_only; ?>" id="name" placeholder="যার কাছে পাবো তার নাম" readonly/></td>
                        <td><input type="text" name="description" class="form-control" size="100" value="<?php echo $description_read_only; ?>" id="description" placeholder="বিবরণ" readonly/></td>
                        <td><input type="text" name="amount" class="form-control" size="100" value="" id="amount" placeholder="টাকা" /></td>
                      </tr>
                  </tbody>
              </table>
          ...
          <?php            
              ...
              $query = "SELECT * FROM entry_nij_paonadar WHERE nij_paonadar_id = '$data_id' AND nij_status ='sub' AND project_name_id = '$project_name_id' ORDER BY nij_date DESC";
              $show = $db->select($query);
              echo '<tr align="center" class="bg-primary">';
                  echo '<td width="75px">ক্রমিক নং</td>';
                  echo '<td width="85px">তারিখ</td>';
                  echo '<td style="width: 440px;">যার কাছে পাবো তার নাম</td>';
                  echo '<td>বিবরণ</td>';
                  echo '<td>টাকা</td>';
              ...
              if(mysqli_num_rows($show) > 0) {
                  echo '<tr>';
                    echo '<td colspan="4" class="text-right">মোট পেয়েছি = </td>';

<?php 
	...
	$db = new Database();
	$_SESSION['pageName'] = 'piling_report_buy_hisab';
...
<!-- 						    <div class="project_heading text-center" >      
		  	...
		  	?>
		  	<div class="project_heading text-center" >      
		    	<h2 class="text-center" style="font-size: 23px; line-height: 22px;">জমা হিসাব রিপোর্ট</h2>
    		...
    		<table class="tableshow">
    			...
    			<tbody>
	    			<?php
	    				$sql = "SELECT * FROM details_piling WHERE project_name_id = $project_name_id";
	    				...
	    				if($result && $row_number > 0){
	    					...
	    					while($row = $result->fetch_assoc()){
	    						...
	    						// }
	    						echo "<td>".$row['marfot_name']."</td>";
	    						echo "<td>".$row['particulars']."</td>";
	    						echo "<td>".$row['bill_cash']."</td>";
	    						// echo "<td>".$row['fee']."</td>";
                                ...
                                echo "<td>".$row['piling_bill']."</td>";
                                echo "<td>".$row['money_back']."</td>";
	...
	<script type="text/javascript">
		$('.back-button').click(function() {
			location.href = "piling_index.php"; 
    // Do your stuff.

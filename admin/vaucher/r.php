<?php 
    ...
    $db = new Database();
    $_SESSION['pageName'] = 'rod_kroy_hisab';
    // $sucMsgPopup = '';
?>
...
<html>
<head>
    <title>রড হিসাব দৈনিক এনট্রি</title>
    <meta charset="utf-8">
                ...
                ?>
                    <div class="project_heading">      
                        <h2 class="headingOfAllProject" id="city_center_id">
                            <?php echo $rows['heading']; ?> <span class="protidinHisab">রড ক্রয় হিসাব</span>
                    ...
                    <form id="insertPopupForm">
                        <table style="width: 100%;">
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="text" onkeypress="return isNumber(event)" name ="motor_cash" class="form-control value-calc-popup" id="motor_cash_popup" placeholder="Enter Motor Cash...">
                                </td>           
                            </tr>
                            <tr>
                                <td>Unload (আনলোড)</td>
                                <td>
                                    <input type="text" onkeypress="return isNumber(event)" name = "motor_cash" name ="unload" class="form-control value-calc-popup" id="unload_popup" placeholder="Unload">
                                </td>
                            </tr>
                            <tr>
                                <td>Cars rent & Redeem (গাড়ী ভাড়া ও)</td>
                                <td>
                            ...
                            <tr>
                                <td>Kg (কে.জি.)</td>
                                <td>
                                    <input onkeypress="return isNumber(event)" name = "motor_cash" type="text" name="kg" class="form-control value-calc-popup" id="kg_popup" placeholder="Enter kg...">
                                </td>
                            </tr>
                            <tr>
                                <td>Para's (দর)</td>
                                <td>
                                    <input onkeypress="return isNumber(event)" name = "motor_cash" type="text" name="paras" class="form-control value-calc-popup" id="paras_popup" placeholder="Enter paras...">
                                </td>
                            </tr>
                            <tr>
                                <td>Credit (মূল)</td>

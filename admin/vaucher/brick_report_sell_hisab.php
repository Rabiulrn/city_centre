<?php 
	...
	$db = new Database();
	$_SESSION['pageName'] = 'brick_report_sell_hisab';
	...
	<div class="bar_con">
		...
		<div class="left_side_bar menu">
			...
			<h4 class="reportHeader" style="text-align: left;"><span class="back-button"><b >&#x2190;</b></span>&nbsp;&nbsp;<b>   রিপোর্ট</b></h4>
    			...
    			<a href="../vaucher/brick_report_sell_hisab.php" class="active">বিক্রয় অনুযায়ী</a>
...
<!-- 						    <div class="project_heading text-center" >      
    		...
    		<table class="tableshow">
    			...
    			<tbody>
	    			<?php
	    				$sql = "SELECT * FROM details_sell_brick WHERE project_name_id = $project_name_id";

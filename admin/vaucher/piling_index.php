	  				...
	  				<p class="tiny_text">Please click on the appropriate icon below in order to access information about shah enterprise.</p>
	  					 <?php
	  						// if($_SESSION['balu_hisab'] == 'yes'){
        						?>
			  					<div class="pannel_con" >
				  					<a href="../vaucher/piling_details_entry.php">
							...
							//   if($_SESSION['balu_category'] == 'yes'){
								?>
								<div class="pannel_con" >
									<a href="../vaucher/piling_hisab_entry.php">
							...
							// }
				  			...
				  			// if($_SESSION['piling_dealer'] == 'yes'){
				  				?>
				  				<div class="pannel_con" >
				  					<a href="../vaucher/piling_dealer_entry.php">
						...
						//    if($_SESSION['balu_report'] == 'yes'){ 
								?>
								<div class="pannel_con" >
									<a href="../vaucher/piling_report_buy_hisab.php">

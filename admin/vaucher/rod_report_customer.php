	...
	<div class="container-fluid" id="">
	    ...
	    <div class="row">
    		<div class="col-md-2 menu">
    			...
    			<!-- <a href="../vaucher/rod_report_customer.php" class="active">কাস্টমার</a> -->
	    	...
	    	<div class="col-md-9 content">
	    		<?php
			  	...
			  	?>
			  	<div class="project_heading text-center" >      
			    	<h2 class="text-center">কাস্টমার</h2>
			    </div>
	    		...
	    		<table class="tableshow">
	    			...
	    			<?php
	    				$sql = "SELECT * FROM customers WHERE project_name_id = '$project_name_id'";

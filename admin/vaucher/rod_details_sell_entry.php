<?php 
    ...
    $db = new Database();
    $_SESSION['pageName'] = 'rod_bikroy_hisab';
?>
...
<html>
<head>
    <title>রড বিক্রয় হিসাব দৈনিক এনট্রি</title>
    <meta charset="utf-8">
...
<body>
    ...
    <div class="container">
            ...
            <!-- <p class="text-center">রড বিক্রয় হিসাব</p> -->
	   ...
	   <div class="bar_con">
        ...
        <div class="main_bar" style="padding-bottom: 0px;">
            <?php
                $ph_id = $_SESSION['project_name_id'];
                $query = "SELECT * FROM project_heading WHERE id = $ph_id";
                $show = $db->select($query);
                ...
                ?>
                    <div class="project_heading">      
                        <h2 class="headingOfAllProject" id="city_center_id">
                            <?php echo $rows['heading']; ?> <span class="protidinHisab">রড বিক্রয় হিসাব</span>
            ...
            <div class="dealerIdSelect">
                <table>
                  <tr>
                    ...
                    <td><?php
                        $sql = "SELECT dealer_id, dealer_name FROM dealers ";
                        $all_custmr_id = $db->select($sql);
                        echo '<select name="dealer_id" id="dealer_id" class="form-control" style="width: 220px;">';
                ...
                <div class="items_all_con" style="background-color: gray; color: white; border: 2px solid black;">
                    <form id="insertPopupForm">
                        <table style="width: 100%;">
                            ...
                            <tr>
                                <td>Motor Cash (গাড়ী ভাড়া)</td>
                                <td>
                                    <input type="text" name = "motor_cash" class="form-control value-calc-popup" id="motor_cash_popup" placeholder="Enter Motor Cash...">
                                </td>           
                            </tr>
                            <tr>
                                <td>Unload (আনলোড)</td>
                            ...
                            <tr>
                                <td>SL No (ক্রমিক নং)</td>
                                <td>
                                    <input type="text" name="sl_no" class="form-control" id="sl_no_popup" placeholder="Enter SL No...">
                                </td>
                            </tr>
                            <tr>
                                <td>Delivery No (ভাউচার নং)</td>
                                <td>
                                    <input type="text" name="delivery_no" class="form-control" id="delivery_no_popup" placeholder="Enter delivery no...">
                                </td>
                            </tr>
                            <tr>
                                <td>Motor (গাড়ী)</td>
                                <td>
                                    <input type="text" name="motor" class="form-control" id="motor_popup" placeholder="Enter number of motor...">
                                </td>
                            </tr>
                            <tr>
                                <td>Motor No (গাড়ী নাম্বার)</td>
                                <td>
                                    <input type="text" name="motor_no" class="form-control" id="motor_no_popup" placeholder="Enter Motor No...">
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td>mm (মি.মি.)</td>
                                <td>
                                    <input type="text" name="mm" class="form-control" id="mm_popup" placeholder="Example '00 mm'...">
                                </td>
                            </tr>
                            <tr>
                                <td>Kg (কে.জি.)</td>
                                <td>
                                    <input type="text" name="kg" class="form-control value-calc-popup" id="kg_popup" placeholder="Enter kg...">
                                </td>
                            </tr>
                            <tr>
                                <td>Para's (দর)</td>
                            ...
                            <tr>
                                <td>Bundil (বান্ডিল)</td>
                                <td>
                                    <input type="text" name="bundil" class="form-control" id="bundil_popup" placeholder="Enter bundil...">
                                </td>
                            </tr>
                            <tr>
                                <td>Total Para's (মোট দাম)</td>
                                <td>
                                    <input type="text" name="total_paras" class="form-control" id="total_paras_popup" placeholder="Enter total_paras...">
                                </td>
                            </tr>                            
                        </table>
                        <h4 class="text-success text-center" id="NewEntrySucMsgPopup"></h4>
                        
                        <input type="hidden" name="rod_details_id" id="rod_details_id">
    ...
    <script type="text/javascript">
        function dealerWiseSummaryDetailsSearchAndEntry(dlrId, restext=false){
            $.ajax({
                url: '../ajaxcall/rod_dealer_wise_summary_details_search_and_sell_entry.php',
                type: 'post',
                data: {
                    dealerId   : dlrId,
                },
      ...
      $(document).on('change', '#dealer_id', function(){
          var optionValue = $('#dealer_id option:selected').val();          
          // alert(optionValue);
          if(optionValue === ''){
      ...
      $("#dealer_id").val("DLAR-100001").change();
    </script>
  ...
  <script type="text/javascript">    
          ...
          $.ajax({
              ...
              success: function (response) {
                ...
                if(response == 'password_matched'){
                    ...
                    ConfirmDialog('Are you sure delete sell details info?',data_delete_id);
                } else {
          ...
          function ConfirmDialog(message, data_delete_id){
              $('<div></div>').appendTo('body')
                                ...
                                .dialog({
                                    ...
                                    buttons: {
                                        Yes: function () {
                                        var urltxt = '../ajaxcall/rod_del_sell_entry_ajax.php';        
                                          $.ajax({
                                            url: urltxt,
                                            type: 'post',
                                            dataType: 'html',
    ...
    <script type="text/javascript">
        function valid(submit_type) {
            ...
            if(submit_type == 'insert'){
                ...
                var urltxt = '../ajaxcall/rod_details_sell_entry_ajax.php';
                ...
                // var formData = new FormData(formElement);
                // var urltxt = '../ajaxcall/rod_update_sell_entry_ajax.php';
    ...
    <script type="text/javascript">
      function edit_rod_details(rod_id){
          ...
          var urltxt = '../ajaxcall/rod_edit_sell_entry_ajax.php';        
          $.ajax({
            url: urltxt,
            type: 'post',
            dataType: 'html',
      ...
      function edit_rod_popup(element, rowid){
          var ctmr_id         = $(element).closest('tr').find('td:eq(0)').text();
  ...
  <script type="text/javascript">
      function getDataByDates(datestr, dealer_id){
          $.ajax({
              url: '../ajaxcall/rod_search_date_sell_entry.php',
              type: 'post',
              data: {
                  optionDate: datestr,
                  dealerId: dealer_id,
      ...
      function getSummaryByDates(datestr, dealer_id){
          $.ajax({
              url: '../ajaxcall/rod_search_date_sell_wise_summary_entry.php',
              type: 'post',
              data: {
                  optionDate: datestr,
                  dealerId: dealer_id,
      ...
      $(document).on('change', '#dateSearchList', function(){
          ...
          // alert(customerId);          
          getDataByDates(optionDate, dealer_id);
          getSummaryByDates(optionDate, dealer_id);
      });
  </script>
  <script type="text/javascript">
      
      $(document).on('click', '#entry_scroll1', function(){
          // var scrollPosition = $('#scrolling-entry-div').scrollLeft();
      ...
      $(document).on('click', '#entry_scroll2', function(){
          // var scrollPosition = $('#scrolling-entry-div').scrollLeft();
          // if(scrollPosition >= 1090 && scrollPosition <= 2200){

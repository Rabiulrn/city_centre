<?php 
	...
	$db = new Database();
	$_SESSION['pageName'] = 'rod_report_buy_hisab';
	...
	<div class="bar_con">
		...
		<div class="left_side_bar menu">
			<div id="left_all_menu_con">
    			...
    			<a href="../vaucher/rod_report_buy_hisab.php" class="active">ক্রয় হিসাব</a>
...
<!-- 						    <div class="project_heading text-center" >      
    		...
    		<table class="tableshow">
    			...
    			<tbody>
	    			<?php
	    				$sql = "SELECT * FROM details WHERE project_name_id = $project_name_id";

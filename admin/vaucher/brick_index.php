	  				...
	  				<p class="tiny_text">Please click on the appropriate icon below in order to access information about shah enterprise.</p>
	  					 <?php
	  						if($_SESSION['balu_kroy_hisab'] == 'yes'){
        						?>
			  					<div class="pannel_con" >
				  					<a href="../vaucher/brick_details_entry.php">
				  			...
				  			if($_SESSION['balu_bikroy_hisab'] == 'yes'){
				  				?>
			  					<div class="pannel_con" >
				  					<a href="../vaucher/brick_details_sell_entry.php">
				  			...
				  			if($_SESSION['balu_category'] == 'yes'){
				  				?>
				  				<div class="pannel_con" >
				  					<a href="../vaucher/brick_hisab_entry.php">
				  			...
				  			if($_SESSION['balu_dealer'] == 'yes'){
				  				?>
				  				<div class="pannel_con" >
				  					<a href="../vaucher/brick_dealer_entry.php">
				  			...
				  			if (isset($_SESSION['brick_stocks']) && $_SESSION['brick_stocks'] == 'yes') {
				  				?>
				  				<!-- <div class="pannel_con" >
				  					<a href="../vaucher/brick_stocks.php">
				  			...
				  			if (isset($_SESSION['brick_buyer']) && $_SESSION['brick_buyer'] == 'yes') {
				  				?>
				  				<div class="pannel_con" >
				  					<a href="../vaucher/brick_buyer_entry.php">
							  ...
							  if($_SESSION['balu_customer'] == 'yes'){
								?>
								<div class="pannel_con" >
									<a href="../vaucher/brick_customer_entry.php">
										<h5 class="pannel_head" style="background-color:#00D089;">
											<img src="../img/logo/add6_square.png" alt="logo" class="img_pannel">
											কাস্টমার এন্ট্রি
										</h5>
							...
							if($_SESSION['cement_report'] == 'yes'){
								?>
								<div class="pannel_con" >
									<a href="../vaucher/brick_report_buy_hisab.php">

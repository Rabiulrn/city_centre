<?php 
	...
	$db = new Database();
	$_SESSION['pageName'] = 'pathor_report_buyer';
...
?> 
	...
	<script type="text/javascript">	
		...
		function fromTodateSearch(fromdate, todate){
			$.ajax({
		        url: "../ajaxcall_rod_report/pathor_report_buyer_fromdate_todate_search.php",
		        type: "post",
		        data: {
		        	fromdate 	: fromdate, 
		        	todate 		: todate,
		...
		function yearMonthSearch(monthvalue, yearvalue){
			$.ajax({
		        url: "../ajaxcall_rod_report/pathor_report_buyer_year_month_search.php",
		        type: "post",
		        data: {
	...
	<script type="text/javascript">
		$(document).on('input', '#search', function(){
			function searchBybuyerName(searchTxt){
			    $.ajax({
			        url: "../ajaxcall_rod_report/pathor_report_buyer_search.php",
			        type: "post",
		...
		function buyerWiseSearch(searchBuyer){
			$.ajax({
		        url: "../ajaxcall_rod_report/pathor_report_buyer_name_wise_search.php",
		        type: "post",
		        data: {
		...
		$(document).on('change', '#searchBuyer', function(){
			...
			if(searchBuyer == 'allbuyers'){
				window.location = '../vaucher/pathor_report_buyer.php';
			} else {

...
if(isset($rod_details_id)){
	...
	// ========================================
	$sql = "UPDATE details_sell SET motor_cash = '$motor_cash', unload = '$unload', cars_rent_redeem = '$car_rent_redeem', information = '$Information', customer_id = '$customer_id', address = '$address', sl_no = '$sl_no', delivery_no = '$delivery_no', motor = '$motor', motor_no = '$motor_no', delivery_date = '$delivery_date', dates = '$dates', partculars = '$partculars', particulars = '$particulars', debit = '$debit', mm = '$mm', kg = '$kg', paras = '$paras', credit = '$credit ', discount = '$discount', balance = '$balance', bundil = '$bundil', total_paras = '$total_paras' WHERE id = '$rod_details_id'";

	if ($db->select($sql) === TRUE) {
	  $sucMsg = "Rod sell details updated Successfully.";
	  echo $sucMsg;
	} else {

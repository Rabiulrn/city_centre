    ...
    <div class="contorlAfterDealer"> 
        <div class="dateSearch"> 
            ...
            <select class="selectpicker" data-style="btn-info" id="dateSearchList">
              ...
              <?php
                  $sql = "SELECT DISTINCT dates FROM details_sell WHERE dealer_id='$dealerId' ORDER BY dates ASC";
                  $result = $db->select($sql);
                  if($result->num_rows > 0){
                      while($row = $result->fetch_assoc()){
                          $dates = $row['dates'];
	    ...
	    <div class="scrolling-div" id="scrolling-entry-div">
	            ...
	            <table border="1" id="detailsEtryTable">
	              <tr>
	                    ...
	                    <td class="widthPercent1">Motor</td>
	                    ...
	                    <td class="widthPercent2">mm</td>
	                    <td class="widthPercent2">Kg</td>
	              ...
	              <tr>
	                    ...
	                    <td>
	                      <input type="text" name="dates" class="form-control" id="dates" onkeypress="datecheckformat(event)" placeholder="dd-mm-yyyy">
	                    </td>
	                    <td>
	            ...
	            <h4 class="text-success text-center" id="NewEntrySucMsg"><?php echo $sucMsg; ?></h4>
	    </div>

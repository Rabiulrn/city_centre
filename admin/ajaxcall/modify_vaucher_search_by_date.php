<?php 
  ...
  $credit_total =0;
  $sql_qrys="SELECT SUM(credit_amount) AS total_credit FROM vaucher_credit WHERE credit_date = '$selectedDate' AND project_name_id = '$project_name_id'";
  ...
  $total_due_credit = 0;
  $sql_qry_due_credit="SELECT SUM(due_credit_amount) AS total_due_credit FROM due WHERE due_debit_date = '$selectedDate' AND project_name_id = '$project_name_id'";
  ...
  $total_due_debit = 0;
  $sql_qry_due_debit="SELECT SUM(due_debit_amount) AS total_due_debit FROM due WHERE due_debit_date = '$selectedDate' AND project_name_id = '$project_name_id'";
  ...
  $sql="SELECT * FROM vaucher_credit WHERE credit_date = '$selectedDate' AND project_name_id = '$project_name_id'";
  ...
  // $sqls="SELECT * FROM nij_paonadar WHERE nij_paona_date = '$selectedDate' AND project_name_id = '$project_name_id'";
  $sqls="SELECT * FROM nij_paonadar WHERE nij_paona_date <= '$selectedDate' AND project_name_id = '$project_name_id'";
  ...
  if($p_reads){
    while ($rows= $p_reads->fetch_assoc()) {
        ...
        $amount = $am;
        // AND nij_date ='$selectedDate' 
        $enp_sql = "SELECT nij_amount, nij_status FROM entry_nij_paonadar WHERE nij_paonadar_id ='" . $id . "' AND nij_date <= '$selectedDate' AND project_name_id = '$project_name_id'";
...
<thead class="noborders">
  <tr>
    ...
    <th class="noborders" style="border: 1px solid transparent !important; border-right: 1px solid #ddd !important; border-bottom: 1px solid #ddd !important; min-width: 90px;"></th>
    <th class="width_200px headerTextAlign">নাম</th>
    <th class="headerTextAlign">টাকাঃ</th>
    <th class="noborders" style="border: 1px solid transparent !important; border-bottom: 1px solid #ddd !important; min-width: 105px;"></th>
    <th class="noborders" style="border: 1px solid transparent !important;"></th>
    <th class="noborders" style="border: 1px solid transparent !important;"></th>
    <th class="noborders" style="border: 1px solid transparent !important;border-bottom: 1px solid #ddd !important; min-width: 90px;"></th>
    <th class="headerTextAlign">নাম</th>
    <th class="headerTextAlign">বিবরণ</th>
    <th class="headerTextAlign">টাকাঃ</th>
    <th class="noborders" style="border: 1px solid transparent !important; border-bottom: 1px solid #ddd !important;"></th>
    <th class="noborders" style="border: 1px solid transparent !important; border-bottom: 1px solid #ddd !important;"></th>
  </tr>
</thead>
<?php  
  $j = 0;
  // $paona_query = "SELECT * FROM jara_pabe WHERE pabe_date = '$selectedDate' AND project_name_id = '$project_name_id'";
  $paona_query = "SELECT * FROM jara_pabe WHERE pabe_date <= '$selectedDate' AND project_name_id = '$project_name_id'";
  ...
  if ($paona_read) {
    while ($paona_row = $paona_read->fetch_assoc()) {
        ...
        $ejp_sql = "SELECT jp_amount, jp_status FROM entry_jara_pabe WHERE jara_pabe_id ='" .$pabe_id . "' AND jp_date <= '$selectedDate' AND project_name_id = '$project_name_id'";
        ...
        if($remain_pabe_amount > 0){
            ...
            <tbody class="borderless-cell">
              <tr>
                ...
                <td><span style="max-width:200px !important; word-wrap: anywhere;"><?php if($j<$sizes){echo $datas[$j]['name']; }?></span></td>
                <td class="text-right">
                    <?php
                        if($j<$sizes){                         
...
?>
  ...
  <?php 
    ...
    while ($row = $read->fetch_assoc()) {        
        ...
        $sql_pabe_amount="SELECT SUM(pabe_amount) AS pabe_amount FROM jara_pabe WHERE project_name_id = '$project_name_id' AND pabe_date = '$selectedDate'";
        ...
        $qry = "SELECT * FROM debit_group_data WHERE group_id = '$debit_group_id' AND entry_date = '$selectedDate'";
        $reads = $db->select($qry);
      ...
      <tbody class="borderless-cell">
        ...
        <tr>
          ...
          <td class="text-right" style="font-weight: bold;">
            ...
            ?></td>
          <td class="text-right" style="font-weight: bold;">পাওনাঃ-</td>
...
<?php 
    ...
    $query = "SELECT id, due_credit_amount, due_debit_amount, due_debit_date FROM due WHERE due_debit_date = '$selectedDate' AND project_name_id = '$project_name_id'";

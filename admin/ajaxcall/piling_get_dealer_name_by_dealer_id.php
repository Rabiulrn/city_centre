<?php 
	...
	$sql = "SELECT dealer_name, address, contact_person_name, mobile FROM piling_dealer WHERE dealer_id = '$dealerId'";
...
?>
		To view select a dealer name, <span class="protidinHisab"> পাইলিং জমা হিসাব</span>
<?php
	}
?>

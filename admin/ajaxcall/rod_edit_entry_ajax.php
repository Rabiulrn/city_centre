              ...
              <tr>
                <td>
                  ...
                  <?php
                    ...
                    echo '<select name="buyer_id" id="buyer_id_edit" class="form-control" style="width: 140px;">';
                ...
                <td>
                  <input onkeypress="datecheckformat(event)" type="text" name="delivery_date" class="form-control" id="delivery_date_edit" placeholder="dd-mm-yy" value="<?php echo $delivery_date; ?>">
                </td>
                <td>
                  <input onkeypress="datecheckformat(event)" type="text" name="dates" class="form-control" id="dates_edit" placeholder="dd-mm-yy" value="<?php echo $dates; ?>">
                </td>
                <td>
                ...
                <td>
                  <input type="text" name="discount" class="form-control" id="discount_edit" placeholder="Enter discount..." value="<?php echo $discount; ?>">
                </td>
                <td>

<?php 
    ...
    $et_para  = isset($_POST['et_para']) ? trim($_POST['et_para']) : '';
    ...
    $voucher_no  = isset($_POST['voucher_no']) ? trim($_POST['voucher_no']) : '';
    ...
    $biboron      = isset($_POST['biboron']) ? trim($_POST['biboron']) : '';
    ...
    $total_credit = isset($_POST['total_credit']) ? trim($_POST['total_credit']) : '';

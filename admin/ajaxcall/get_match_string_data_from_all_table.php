...
//total calculation section
  $credit_total = 0;
  $sql_qry="SELECT SUM(credit_amount) AS total_credit FROM vaucher_credit WHERE credit_name LIKE '%$match_string%' AND project_name_id = '$project_name_id'";
...
?>
    <thead>
        <tr class="active">
            <th class="text-center">জমা মারফোত নামঃ
            </th>
            ...
            <!-- <th class="text-center">নগদ পরি‌ষদঃ</th> -->
  ...
  ?>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td class="text-right"><?php echo number_format($total_due_credit, 2); ?></td>
            <td id="borderless-cell"></td>
            <td id="noborders"></td>
            <td id="noborders"></td>
            <!-- <td id="noborders"></td> -->
            <td class="text-right">পূরব‌ের পাওনাঃ-</td>
            <td class="text-right"><?php echo number_format($total_due_debit, 2); ?></td>
            <td id="noborders"></td>
            <td id="noborders"></td>
          </tr>
      </tbody>

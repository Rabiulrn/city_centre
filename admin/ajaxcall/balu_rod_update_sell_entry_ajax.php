...
$sql ="UPDATE `details_sell_balu` SET `motor_name`='$motor_name',`driver_name`='$driver_name',`motor_vara`='$motor_vara',`unload`='$unload',`cars_rent_redeem`='$car_rent_redeem',`information`='$information',`sl`='$sl',`voucher_no`='$voucher_no',`address`='$address',`motor_no`='$motor_number ',`motor_sl`='$motor_sl ',`delivery_date`='$delivery_date',`dates`='$dates',`partculars`='$partculars ',`particulars`='$particulars',`debit`='$debit',`ton & kg`='$ton_kg' WHERE id = '$balu_details_id'";

<?php 
  ...
  $credit_total = 0;
  $sql_qry="SELECT SUM(credit_amount) AS total_credit FROM vaucher_credit WHERE project_name_id = '$project_name_id' ORDER BY id DESC LIMIT 10";
...
<?php
  ...
  <thead>
    <tr class="active">
      ...
      <!-- <th class="text-right active  text-center" style='font-size: 13px;'>নগদ পরি‌ষদঃ</th> -->

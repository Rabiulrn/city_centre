<?php 
	...
	// echo $dealerId;
	if (isset($_POST['dealerId']) && !empty($_POST['dealerId'])) {
        $dealerId = $_POST['dealerId'];
	...
	$sql = "SELECT dealer_name, address, contact_person_name, mobile FROM dealers WHERE dealer_id = '$dealerId'";
...
?>
		To view select a dealer name, <span class="protidinHisab">রড ক্রয় হিসাব</span>
<?php
	}
?>

...
?>
  ...
  ?>
      ...
      <thead id="noborders" class="text-format">
          <tr class="d-flex">
            ...
            <th id="borderless-cell"></th>
            <th id="borderless-cell"></th>
            <th class="active width_110px">পাওনার নামঃ </th>
  ...
  <?php 
    $i=0;
    $query = "SELECT * FROM debit_group WHERE group_date = '$optionDate' AND project_name_id = '$project_name_id'";
    ...
    ?>
        <tbody>
          <tr class="d-flex">
            ...
            <td class="newGroup"><?php echo $row['group_name']; ?></td>
            <td class="newGroup"><?php echo $row['group_description']; ?></td>
            <td class="newGroup text-right"><?php echo $row['taka']; ?></td>
            <td class="newGroup text-right"><?php echo $row['pices']; ?></td>
            <td class="newGroup text-right"><?php echo $row['total_taka']; ?></td>
            <td class="newGroup text-right"><?php echo $row['total_bill']; ?></td>
            <td class="newGroup text-right"><?php echo $row['pay']; ?></td>
            <td class="newGroup text-right"><?php echo $row['due']; ?></td>
          </tr>
        </tbody>
      ...
      $sql_pabe_amount="SELECT SUM(pabe_amount) AS pabe_amount FROM jara_pabe WHERE project_name= '$project_name_id'";
    ...
    ?>
          ...
          <tbody>
            <tr class="d-flex">
              ...
              <td class="text-right"><?php echo $row['group_pay']; ?></td>

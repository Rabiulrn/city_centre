...
<?php
	$sql = "SELECT * FROM customers_brick WHERE customer_name LIKE '%$searchTxt%' AND project_name_id = '$project_name_id'";
	...
	if($result && $row_number > 0){
		...
		while($row = $result->fetch_assoc()){
			...
			// $sql2 = "SELECT SUM(kg) as kg FROM details_sell_brick WHERE particulars LIKE '%500W%' AND customer_id = '$customer_id' AND project_name_id = '$project_name_id'";
	        ...
	        //     $rod500w = 0;
	        // }
	        // $sql2 = "SELECT SUM(kg) as kg FROM details_sell_brick WHERE particulars LIKE '%400W%' AND customer_id = '$customer_id' AND project_name_id = '$project_name_id'";
	        // $result2 = $db->select($sql2);
	        // if($result2->num_rows > 0){
	        //     while($row2 = $result2->fetch_assoc()){
	        //         $rod400w = $row2['kg'];
	        ...
	        // 	$total_motor = 0;
		    //     $sql2 = "SELECT SUM(motor) as motor FROM details_sell_brick WHERE customer_id = '$customer_id' AND project_name_id = '$project_name_id'";
		    //     $result2 = $db->select($sql2);
		    //     if($result2->num_rows > 0){
		    //         while($row2 = $result2->fetch_assoc()){

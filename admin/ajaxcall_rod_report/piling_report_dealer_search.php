...
<?php
	$sql = "SELECT * FROM piling_dealer WHERE dealer_name LIKE '%$searchTxt%' AND project_name_id = '$project_name_id'";
	...
	if($result && $row_number > 0){
		...
		//     $company_paona = ($total_debit - $total_credit) - $gb_bank_ganti;
			...
			echo "<td style='border: 1px solid #777 !important;'>".$piling_count." টাকা</td>";

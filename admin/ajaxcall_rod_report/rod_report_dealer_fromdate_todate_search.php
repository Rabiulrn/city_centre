<?php
	...
	if($fromdate == ''){
		...
		$sql = "SELECT * FROM dealers WHERE project_name_id = '$project_name_id'";
		...
		if($result && $row_number > 0){
			...
			while($row = $result->fetch_assoc()){
				...
				$sql2 = "SELECT SUM(kg) as kg FROM details WHERE particulars LIKE '%500W%' AND dealer_id = '$dealer_id' AND project_name_id = '$project_name_id' AND dates BETWEEN '$fromdate' AND '$todate'";
		        ...
		        $sql2 = "SELECT SUM(kg) as kg FROM details WHERE particulars LIKE '%400W%' AND dealer_id = '$dealer_id' AND project_name_id = '$project_name_id' AND dates BETWEEN '$fromdate' AND '$todate'";
		        $result2 = $db->select($sql2);
		        if($result2->num_rows > 0){
		            while($row2 = $result2->fetch_assoc()){
		                $rod400w = $row2['kg'];
		        ...
		        // Start total total_motor
		        	$total_motor = 0;
			        $sql2 = "SELECT SUM(motor) as motor FROM details WHERE dealer_id = '$dealer_id' AND project_name_id = '$project_name_id' AND dates BETWEEN '$fromdate' AND '$todate'";
			        $result2 = $db->select($sql2);
			        if($result2->num_rows > 0){
			            while($row2 = $result2->fetch_assoc()){
		        ...
		        //Start Gari vara
		        	$motor_cash = 0;
			        $sql2 = "SELECT SUM(motor_cash) as motor_cash FROM details WHERE dealer_id = '$dealer_id' AND project_name_id = '$project_name_id' AND dates BETWEEN '$fromdate' AND '$todate'";
			        $result2 = $db->select($sql2);
			        if($result2->num_rows > 0){
			            while($row2 = $result2->fetch_assoc()){
			    ...
			    //Start khalas/Unload
			        $unload = 0;
			        $sql2 = "SELECT SUM(unload) as unload FROM details WHERE dealer_id = '$dealer_id' AND project_name_id = '$project_name_id' AND dates BETWEEN '$fromdate' AND '$todate'";
			        $result2 = $db->select($sql2);
			        if($result2->num_rows > 0){
			            while($row2 = $result2->fetch_assoc()){
			                $unload = $row2['unload'];
			    ...
			    // Start total total_credit/mot_mul
			        $total_credit = 0;
			        $sql2 = "SELECT SUM(credit) as credit FROM details WHERE dealer_id = '$dealer_id' AND project_name_id = '$project_name_id' AND dates BETWEEN '$fromdate' AND '$todate'";
			        $result2 = $db->select($sql2);
			        if($result2->num_rows > 0){
			            while($row2 = $result2->fetch_assoc()){
			    ...
			    // Start total total_debit/joma
			        $total_debit = 0;
			        $sql2 = "SELECT SUM(debit) as debit FROM details WHERE dealer_id = '$dealer_id' AND project_name_id = '$project_name_id' AND dates BETWEEN '$fromdate' AND '$todate'";
			        $result2 = $db->select($sql2);
			        if($result2->num_rows > 0){
			            while($row2 = $result2->fetch_assoc()){
			    ...
			    // Start total total_Balance/mot_jer
			        $total_balance = 0;
			        $sql2 = "SELECT SUM(balance) as balance FROM details WHERE dealer_id = '$dealer_id' AND project_name_id = '$project_name_id' AND dates BETWEEN '$fromdate' AND '$todate'";
			        $result2 = $db->select($sql2);
			        if($result2->num_rows > 0){
			            while($row2 = $result2->fetch_assoc()){
			...
			//Start Total para/mot_mul_khoros_shoho
			        $total_paras = 0;
			        $sql2 = "SELECT SUM(total_paras) as total_paras FROM details WHERE dealer_id = '$dealer_id' AND project_name_id = '$project_name_id' AND dates BETWEEN '$fromdate' AND '$todate'";
			        $result2 = $db->select($sql2);
			        if($result2->num_rows > 0){
			            while($row2 = $result2->fetch_assoc()){

...
if ($fromdate == '') {
	...
	if ($result && $row_number > 0) {
		...
		echo "<tr>";
						...
						echo "<th style='border: 1px solid #777 !important;'>জমা টাকা</td>";
						echo "<th style='border: 1px solid #777 !important;'>পাইলিং পরিমান</td>";

						echo "<th style='border: 1px solid #777 !important;'>পাইলিং বিল</th>";
						echo "<th style='border: 1px solid #777 !important;'>অতিরিক্ত টাকা ফেরত</th>";
		...
		while ($row = $result->fetch_assoc()) {
			...
			//Start Gari vara
			// $motor_vara = 0;
			// $sql2 = "SELECT SUM(motor_vara) as motor_vara FROM details_piling WHERE dealer_id = '$dealer_id' AND project_name_id = '$project_name_id'";
			...
			// $total_motor_vara = 0;
			// 			        $sql3 = "SELECT SUM(motor_vara) as motor_vara FROM details_piling WHERE project_name_id = '$project_name_id'";
		    ...
		    //Start khalas/Unload
		//         $unload = 0;
		//         $sql2 = "SELECT SUM(unload) as unload FROM details_piling WHERE dealer_id = '$dealer_id' AND project_name_id = '$project_name_id'";
		//         $result2 = $db->select($sql2);
		//         if($result2->num_rows > 0){
		//             while($row2 = $result2->fetch_assoc()){
		//                 $unload = $row2['unload'];
		...
		// 		$total_unload = 0;
		// 						$sql3 = "SELECT SUM(unload) as unload FROM details_piling WHERE  project_name_id = '$project_name_id'";
		// 						$result3 = $db->select($sql3);
		// 						if($result3->num_rows > 0){
		// 							while($row3 = $result3->fetch_assoc()){
		...
		//     // Start total total_credit/mot_mul
		//         $total_credit = 0;
		//         $sql2 = "SELECT SUM(credit) as credit FROM details_piling WHERE dealer_id = '$dealer_id' AND project_name_id = '$project_name_id'";
		//         $result2 = $db->select($sql2);
		//         if($result2->num_rows > 0){
		//             while($row2 = $result2->fetch_assoc()){
		//                 $total_credit = $row2['credit'];
		...
		// 		$total1_credit = 0;
		// 				        $sql3 = "SELECT SUM(credit) as credit FROM details_piling WHERE project_name_id = '$project_name_id'";
		// 				        $result3 = $db->select($sql3);
		// 				        if($result3->num_rows > 0){
		// 				            while($row3 = $result3->fetch_assoc()){
		...
		//     // Start total total_debit/joma
		//         $total_debit = 0;
		//         $sql2 = "SELECT SUM(debit) as debit FROM details_piling WHERE dealer_id = '$dealer_id' AND project_name_id = '$project_name_id'";
		//         $result2 = $db->select($sql2);
		//         if($result2->num_rows > 0){
		//             while($row2 = $result2->fetch_assoc()){
		//                 $total_debit = $row2['debit'];
		...
		// 		$total1_debit = 0;
		// 				        $sql3 = "SELECT SUM(debit) as debit FROM details_piling WHERE project_name_id = '$project_name_id'";
		// 				        $result3 = $db->select($sql3);
		// 				        if($result3->num_rows > 0){
		// 				            while($row3 = $result3->fetch_assoc()){
		...
		//     // Start total total_Balance/mot_jer
		//         $total_balance = 0;
		//         $sql2 = "SELECT SUM(balance) as balance FROM details_piling WHERE dealer_id = '$dealer_id' AND project_name_id = '$project_name_id'";
		//         $result2 = $db->select($sql2);
		//         if($result2->num_rows > 0){
		//             while($row2 = $result2->fetch_assoc()){
		//                 $total_balance = $row2['balance'];
		...
		// 		$total1_balance = 0;
		// 		$sql3 = "SELECT SUM(balance) as balance FROM details_piling WHERE  project_name_id = '$project_name_id'";
		// 		$result3 = $db->select($sql3);
		// 		if($result3->num_rows > 0){
		// 			while($row3 = $result3->fetch_assoc()){
		...
		//     //Start GB Bank Ganti
		//         $gb_bank_ganti = 0;
		//         $sql2 = "SELECT SUM(debit) as debit, id FROM details_piling WHERE particulars = 'BG' AND dealer_id = '$dealer_id' AND project_name_id = '$project_name_id'";
		//         $result2 = $db->select($sql2);
		//         if($result2->num_rows > 0){
		//             while($row2 = $result2->fetch_assoc()){
		//                 $gb_bank_ganti = $row2['debit'];
